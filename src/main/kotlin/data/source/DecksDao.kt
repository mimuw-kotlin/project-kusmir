...
interface DecksDao {
    ...
    suspend fun insertCardIntoMainDeck(
        cardId: Uuid,
        deckId: Long,
    )

    suspend fun insertCardIntoSideboard(
        cardId: Uuid,
        deckId: Long,
    )

    suspend fun insertCardsIntoMainDeck(
        cardIds: List<Uuid>,
        deckId: Long,
    )

    suspend fun insertCardsIntoSideboard(
        cardIds: List<Uuid>,
        deckId: Long,
    )
    ...
    suspend fun deleteCardFromMainDeck(
        cardId: Uuid,
        deckId: Long,
    )

    suspend fun deleteCardFromSideboard(
        cardId: Uuid,
        deckId: Long,
    )

    suspend fun deleteCardsFromMainDeck(
        cardIds: List<Uuid>,
        deckId: Long,
    )

    suspend fun deleteCardsFromSideboard(
        cardIds: List<Uuid>,
        deckId: Long,
    )
