...
class CardModelAdapter {
    ...
    fun fromJsonToDatabase(jsonObject: JsonObject): CardDb {
        val id = jsonObject.get("oracle_id").asString.toUuid()
        val name = jsonObject.get("name").asString
        val colorIdentity = jsonObject
        ...
        val layout = jsonObject.get("layout").asString
