...
sealed class EditDeckEvent {
    data class AddCard(
        val cardName: String,
        val type: Deck.ListType? = null,
    ) : EditDeckEvent()

    data class RemoveCard(
        val cardName: String,
        val type: Deck.ListType,
    ) : EditDeckEvent()
    ...
    data class EnteredDeckName(
        val name: String,
    ) : EditDeckEvent()

    data class ChangeDeckImage(
        val cardName: String,
    ) : EditDeckEvent()
    ...
    sealed class AddCardEvent {
        ...
        data class SelectTargetDeckListType(
            val id: Int,
        ) : AddCardEvent()
    }
    ...
    sealed class ImportDeckEvent {
        ...
        data class EnteredDeckImportValue(
            val input: String,
        ) : ImportDeckEvent()
